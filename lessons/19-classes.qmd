...
- 📓 **[Open in JupyterLite](../jupyterlite/lab/index.html?path=lessons/19-classes.ipynb)** - Full Jupyter environment in your browser
- ▶️ **Run code directly below** - All code cells on this page are editable and runnable
- 📥 **[Download Notebook](../files/lessons/19-classes.ipynb)** - For use in local Jupyter or Google Colab
:::
