...
- 📓 **[Open in JupyterLite](../jupyterlite/lab/index.html?path=lessons/10-number-game.ipynb)** - Full Jupyter environment in your browser
- ▶️ **Run code directly below** - All code cells on this page are editable and runnable
- 📥 **[Download Notebook](../files/lessons/10-number-game.ipynb)** - For use in local Jupyter or Google Colab
:::
