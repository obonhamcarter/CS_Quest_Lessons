...
- 📓 **[Open in JupyterLite](../jupyterlite/lab/index.html?path=lessons/07-dictionaries.ipynb)** - Full Jupyter environment in your browser
- ▶️ **Run code directly below** - All code cells on this page are editable and runnable
- 📥 **[Download Notebook](../files/lessons/07-dictionaries.ipynb)** - For use in local Jupyter or Google Colab
:::
