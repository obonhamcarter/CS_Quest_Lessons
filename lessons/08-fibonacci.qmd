...
- 📓 **[Open in JupyterLite](../jupyterlite/lab/index.html?path=lessons/08-fibonacci.ipynb)** - Full Jupyter environment in your browser
- ▶️ **Run code directly below** - All code cells on this page are editable and runnable
- 📥 **[Download Notebook](../files/lessons/08-fibonacci.ipynb)** - For use in local Jupyter or Google Colab
:::
