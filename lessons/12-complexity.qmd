...
- 📓 **[Open in JupyterLite](../jupyterlite/lab/index.html?path=lessons/12-complexity.ipynb)** - Full Jupyter environment in your browser
- ▶️ **Run code directly below** - All code cells on this page are editable and runnable
- 📥 **[Download Notebook](../files/lessons/12-complexity.ipynb)** - For use in local Jupyter or Google Colab
:::
